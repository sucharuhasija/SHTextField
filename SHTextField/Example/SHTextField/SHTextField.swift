...
public class SHTextField: UITextField ,UITextFieldDelegate{
...
// MARK:  Initilizers
    ...
    private func initilizeNormalSupportAutoComple(value:Bool)
    {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector:#selector(SHTextField.tfTextDidChange), name: UITextFieldTextDidChangeNotification, object: self)
        NSNotificationCenter.defaultCenter().addObserver(self, selector:#selector(SHTextField.CheckValidityOfText),name: UITextFieldTextDidEndEditingNotification, object: self)
        NSNotificationCenter.defaultCenter().addObserver(self, selector:#selector(SHTextField.tfStartTyping), name: UITextFieldTextDidBeginEditingNotification, object: self)
